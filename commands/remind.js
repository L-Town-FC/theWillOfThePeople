module.exports = {
    ...
    execute(message, args,reminder_list, bot, master){
        ...
        try{    
            ...
            console.log(err)
            message.channel.send('Error occurred in remind.js')
        }
    }
}
...
async function Reminder(message, args, amount, units, reminder_list, bot){
    ...
    try{    
        ...
        console.log(err)
        message.channel.send('Error occurred in remind.js reminder')
    }
}
...
async function Reminder_List(message, args, reminder_list, master){
    ...
    try{
        ...
        console.log(err)
        message.channel.send('Error occurred in remind.js list')
    }
}
...
async function Months(message, args, reminder_list){
    ...
    try{    
        ...
        console.log(err)
        message.channel.send('Error occurred in remind.js months')
    }
}
...
function Help(message, args){
    ...
    try{    
        ...
        console.log(err)
        message.channel.send('Error occurred in remind.js help')
    }
