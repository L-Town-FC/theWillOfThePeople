module.exports = {
    ...
    execute(message,args, master, stats, tracker, command_stats, remind){
        const fs = require('fs')
        ...
        fs.writeFileSync ("./JSON/reminders.json", JSON.stringify(remind, null, 2), function(err) {
            if (err) throw err;
            console.log('complete');
            }
        );
        ...
        var reminders = new Attachment('./JSON/reminders.json')
